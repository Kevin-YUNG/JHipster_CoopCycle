...
describe('Commerce e2e test', () => {
  ...
  it('should load Commerce', async () => {
    ...
    expect(await commerceComponentsPage.getTitle()).to.eq('jHipsterApp.commerce.home.title');
  ...
  it('should load create Commerce page', async () => {
    ...
    expect(await commerceUpdatePage.getPageTitle()).to.eq('jHipsterApp.commerce.home.createOrEditLabel');
  ...
  it('should delete last Commerce', async () => {
    ...
    expect(await commerceDeleteDialog.getDialogTitle()).to.eq('jHipsterApp.commerce.delete.question');
