...
describe('AutreCommerce e2e test', () => {
  ...
  it('should load AutreCommerces', async () => {
    ...
    expect(await autreCommerceComponentsPage.getTitle()).to.eq('jHipsterApp.autreCommerce.home.title');
    await browser.wait(
  ...
  it('should load create AutreCommerce page', async () => {
    ...
    expect(await autreCommerceUpdatePage.getPageTitle()).to.eq('jHipsterApp.autreCommerce.home.createOrEditLabel');
  ...
  it('should delete last AutreCommerce', async () => {
    ...
    expect(await autreCommerceDeleteDialog.getDialogTitle()).to.eq('jHipsterApp.autreCommerce.delete.question');
