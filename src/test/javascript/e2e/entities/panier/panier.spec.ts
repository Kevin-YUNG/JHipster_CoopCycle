...
describe('Panier e2e test', () => {
  ...
  it('should load Paniers', async () => {
    ...
    expect(await panierComponentsPage.getTitle()).to.eq('jHipsterApp.panier.home.title');
  ...
  it('should load create Panier page', async () => {
    ...
    expect(await panierUpdatePage.getPageTitle()).to.eq('jHipsterApp.panier.home.createOrEditLabel');
  ...
  it('should delete last Panier', async () => {
    ...
    expect(await panierDeleteDialog.getDialogTitle()).to.eq('jHipsterApp.panier.delete.question');
